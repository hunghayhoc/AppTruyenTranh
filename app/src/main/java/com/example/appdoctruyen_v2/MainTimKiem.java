...
// liên kết  vs id trong layout
        //ActionBar();
        initList();
// vào editext  gọi filer : tìm kiếm  lọc danh sách  truyện  theo tên chứa từ khóa
...
// tạo list để chứa  danh sách kết quả lọc
        for(Truyen item : TruyenArrayList){
            if (item.getTenTruyen().toLowerCase().contains(text.toLowerCase())){// phân biết chữ hoa vs thường
...
// hiển thi danh sách truyện
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getApplicationContext(), RecyclerView.VERTICAL, false);
        listView.setLayoutManager(linearLayoutManager);
// tạo adapter để  truyền  danh sách truyện  gán vao recycclerview
...
//initList() lấy dữ liệu từ SQLite, gắn vào RecyclerView
//Người dùng nhập chữ vào EditText
//TextWatcher.afterTextChanged() gọi filter()
//filter() lọc danh sách truyện theo tên có chứa từ khóa
//Adapter cập nhật danh sách hiển thị theo kết quả tìm kiếm
