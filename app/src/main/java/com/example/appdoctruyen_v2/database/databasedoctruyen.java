...
public class databasedoctruyen extends SQLiteOpenHelper{
  ...
  private String SQLQuery2 = "INSERT INTO TaiKhoan VAlUES (null,'admin','admin','admin@gmail.com',2)";
   private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'hung','hunghoang','hung@gmail.com',1)";
...
//        db.execSQL(SQLQuery12);
    ...
    public void AddTaiKhoan(TaiKhoan taiKhoan){
        ...
        values.put(TEN_TAI_KHOAN,taiKhoan.getmTenTaiKhoan());// Gán gtri cho từng cô
        values.put(MAT_KHAU,taiKhoan.getmMatKhau());
        values.put(EMAIL,taiKhoan.getmEmail());
        values.put(PHAN_QUYEN,taiKhoan.getmPhanQuyen());

        db.insert(TABLE_TAIKHOAN,null,values); // ghi dòng mới vào  bảng
    ...
    public Cursor getData(){
        SQLiteDatabase db = this.getReadableDatabase(); // mở database để ghi dữ liệu
...
// chạy  câu lệnh để  dữ liệu từ bảng truện
    ...
    public int Delete(int i){
        SQLiteDatabase db = this.getReadableDatabase();
// xóa truỵen trùng vs id truyền vào
