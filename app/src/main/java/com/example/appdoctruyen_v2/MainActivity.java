...
import static com.example.appdoctruyen_v2.R.*;
...
// gọi init  cài thanh BottomNavigationView   xử lý khi người dùng bấm vào thành dưới
        init();
    ...
    private void loadFragment(Fragment fragment) {
        // load fragment  thay thế framaent
    ...
    public void init(){
        ...
        //Tạo thanh menu  bên trái danh sách menu
        ...
        fragmentClass =  HomeFragment.class;// lưu lại  fragment  sẽ hiện thị
        try {
